...
const NavBar = () => {
	...
	return (
		<div
			className='lg:flex justify-between  z-50 absolute  top-0 w-full h-screen 
		text-white text-center'>
			<div
				...
				<img
					src={logo}
					alt=''
					className='w-[200px]  relative top-0 mt-2 ml-2 p-2 lg:h-max'
				/>
				{toggle ? (
					<TfiClose
			...
			<ul
				className={` absolute lg:mr-2 bg-primary-100 lg:p-6  lg:bg-inherit lg:backdrop-blur-none bg-opacity-30 backdrop-blur-lg transition-all ease duration-700 flex flex-col lg:flex-row lg:relative lg:opacity-100 lg:justify-end justify-center h-1/4 lg:h-max lg:w-1/2 w-full z-10 ${
