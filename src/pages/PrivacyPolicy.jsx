  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <p className="text-gray-700 mb-4">
        ...
        information when you visit our website [Your Website URL] (the &quot;Site&quot;). Please
      ...
      <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
        <li>
          Personal Data: Personally identifiable information, such as your name, email address, and
          telephone number, that you voluntarily give to us when you use our contact forms or
      ...
      <ul className="list-disc list-inside text-gray-700 mb-4 ml-4">
        ...
        <li>
          ...
          perform services for us or on our behalf, including data analysis, email delivery, hosting
          services, customer service, and marketing assistance (e.g., Calendly for scheduling).
        </li>
